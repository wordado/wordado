...
export const en = {
  ...
  'error.notReady': 'Wordado is still opening. Try again in a moment.',
  'error.unknown': 'Something went wrong. Try again.',
  'error.offline': 'You’re offline. Try again when you’re connected.',
  'error.signIn': 'Your sign-in has expired. Sign in again.',
  'error.tooMany': 'Too many tries. Wait a moment and try again.',
  'error.server': 'Wordado isn’t answering properly right now. Try again later.',
